...
const Informacion = () => {
  return (
    <div>
      <p className='ptexto'>Nuestro objetivo es brindarte una experiencia de aprendizaje enriquecedora, práctica y personalizada.
                      Ya sea que estés buscando expandir tus conocimientos, adquirir nuevas habilidades o mejorar en tu campo profesional, 
                      nuestros cursos en vivo te brindarán la oportunidad de interactuar directamente con instructores calificados y otros estudiantes apasionados.
                      Aprovecha la flexibilidad de nuestro formato en línea y accede a los cursos desde la comodidad de tu hogar. 
        </p>
      <div className='informacion'>
        ...
        <p className='contacto'>Si tienes más dudas o deseas contactarnos, no dudes en escribirnos a <span className='subrayado'>e.ducacion@gmail.com</span> para recibir asistencia personalizada.</p>
